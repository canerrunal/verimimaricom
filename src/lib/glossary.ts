...
export const glossaryTerms: GlossaryTerm[] = [
  {
    ...
    example:
      '40.000 TL atfedilen gelir ve 10.000 TL reklam harcaması varsa ROAS 4,0’dır. Ürünün başabaş eşiği 4,5 ise iyi görünen bu sonuç yine zarar üretebilir.',
    confusedWith: {
      term: 'MER',
      slug: 'mer',
      explanation:
        'ROAS kampanya veya platform atfına; MER toplam gelir ve toplam pazarlama giderine bakar.',
    },
    relatedGuide: {
      label: 'ROAS yüksekken kâr neden düşebilir?',
  ...
  },
  {
    slug: 'basabas-roas',
    term: 'Başabaş ROAS',
    english: 'Break-even ROAS',
    category: 'Kârlılık',
    shortDefinition:
      'Reklam gelirinin siparişin değişken maliyetleriyle reklam giderini tam karşıladığı ROAS seviyesidir.',
    explanation: [
    ...
    formulaNote:
      'Katkı payına ürün, komisyon, ödeme, kargo, paketleme ve beklenen iade maliyeti dahil edilmelidir.',
    example:
      '1.000 TL net gelirli sipariş reklam öncesi 360 TL bırakıyorsa başabaş ROAS 1.000 ÷ 360 = 2,78’dir.',
    confusedWith: {
      term: 'Hedef ROAS',
      explanation:
        'Başabaş ROAS sıfır kâr eşiğidir; hedef ROAS korunmak istenen kâr ve güvenlik payını da içerir.',
    },
    relatedGuide: {
      label: 'Başabaş ROAS nasıl hesaplanır?',
  ...
  },
  {
    slug: 'mer',
    term: 'MER',
    english: 'Marketing Efficiency Ratio',
    category: 'Reklam',
    ...
    confusedWith: {
      ...
      slug: 'roas',
      explanation:
        'ROAS atfedilen kampanya gelirini; MER bütün şirket gelirini ve pazarlama giderini kullanır.',
    },
    relatedGuide: {
      label: 'MER nedir, nasıl hesaplanır?',
      href: '/rehberler/mer-nedir-nasil-hesaplanir',
    },
    source: googleChannels,
    reviewedAt: '2026-08-01',
  },
  {
    slug: 'poas',
    term: 'POAS',
    english: 'Profit on Ad Spend',
    category: 'Reklam',
    ...
    confusedWith: {
      term: 'ROAS',
      slug: 'roas',
      explanation: 'ROAS geliri, POAS tanımlanmış kâr katmanını reklam maliyetine böler.',
    },
    relatedGuide: {
      label: 'ROAS yüksekken kâr neden düşebilir?',
      href: '/rehberler/roas-yuksekken-kar-neden-duser',
    },
    source: shopifyContribution,
    reviewedAt: '2026-08-01',
  },
  {
    slug: 'cpa',
    term: 'CPA',
    english: 'Cost per Action / Acquisition',
    category: 'Reklam',
    ...
    confusedWith: {
      term: 'CAC',
      slug: 'cac',
      explanation: 'CPA herhangi bir aksiyonu; CAC yalnız yeni müşteri edinimini ölçer.',
    },
    relatedGuide: {
      label: 'Maksimum CPA nasıl hesaplanır?',
      href: '/rehberler/maksimum-cpa-nasil-hesaplanir',
    },
    relatedTool: {
      label: 'Başabaş ROAS ve CPA Hesaplayıcı',
  ...
  },
  {
    ...
    category: 'Müşteri',
    shortDefinition:
      'Belirli bir dönemde kazanılan her yeni müşteri için yapılan edinme harcamasıdır.',
    explanation: [
    ...
    confusedWith: {
      ...
      slug: 'cpa',
      explanation:
        'Her satın alma yeni müşteriden gelmediği için sipariş CPA’sı CAC’dan farklı olabilir.',
    },
    relatedGuide: {
      label: 'Maksimum CPA nasıl hesaplanır?',
      href: '/rehberler/maksimum-cpa-nasil-hesaplanir',
  ...
  },
  {
    ...
    category: 'Kârlılık',
    shortDefinition:
      'Net satıştan değişken giderler çıkarıldıktan sonra sabit gider ve kâr için kalan tutardır.',
    explanation: [
    ...
    example:
      '1.200 TL net satış ve 1.000 TL değişken gider varsa katkı payı 200 TL, katkı oranı %16,7’dir.',
    confusedWith: {
      term: 'Net kâr',
      slug: 'net-kar',
      explanation:
        'Katkı payından sabit giderler henüz çıkarılmamıştır; net kâr tüm giderler sonrasıdır.',
    },
  ...
  },
  {
    ...
    category: 'Kârlılık',
    shortDefinition:
      'Net satıştan satılan malın doğrudan maliyeti çıkarıldıktan sonra kalan tutardır.',
    explanation: [
    ...
    confusedWith: {
      term: 'Katkı payı',
      slug: 'katki-payi',
      explanation: 'Katkı payı komisyon ve kargo gibi diğer değişken giderleri de kapsayabilir.',
    },
    relatedGuide: {
      label: 'E-ticaret kâr marjı nasıl hesaplanır?',
      href: '/rehberler/e-ticaret-kar-marji-nasil-hesaplanir',
    },
    relatedTool: { label: 'Kâr Marjı Hesaplayıcı', href: '/araclar/kar-marji-hesaplayici' },
    source: shopifyMargin,
    reviewedAt: '2026-08-01',
  },
  {
    slug: 'net-kar',
    ...
    category: 'Kârlılık',
    shortDefinition:
      'Dönem gelirinden faaliyet, finansman, vergi ve diğer bütün giderler çıkarıldıktan sonra kalan sonuçtur.',
    explanation: [
    ...
    example:
      'Aylık 3 milyon TL net satış ve 2,7 milyon TL toplam gider varsa net kâr 300 bin TL, net marj %10’dur.',
    confusedWith: {
      term: 'Katkı payı',
      slug: 'katki-payi',
      explanation:
        'Katkı payı sabit gider öncesi birim ekonomiyi; net kâr bütün şirket sonucunu gösterir.',
    },
    relatedGuide: {
      label: 'E-ticaret kâr marjı nasıl hesaplanır?',
      href: '/rehberler/e-ticaret-kar-marji-nasil-hesaplanir',
  ...
  },
  {
    ...
    example:
      '150 TL satış fiyatı ve 100 TL maliyette kâr 50 TL’dir; marj %33,3, maliyet üzerine eklenen oran ise %50’dir.',
    confusedWith: {
      term: 'Kâr oranı / markup',
      explanation: 'Markup kârı maliyete, marj kârı satış fiyatına böler.',
    },
    relatedGuide: {
      label: 'E-ticaret kâr marjı nasıl hesaplanır?',
      href: '/rehberler/e-ticaret-kar-marji-nasil-hesaplanir',
  ...
  },
  {
    ...
    formulaNote:
      'Oransal ve sabit tutarlı sipariş giderlerini ayrı modellemek daha doğru sonuç verir.',
    example:
      'Sipariş başına 90 TL kargo gideri 1.000 siparişte toplam 90.000 TL değişken gider oluşturur.',
    confusedWith: {
      term: 'Sabit gider',
      slug: 'sabit-gider',
      explanation: 'Sabit gider kısa vadede sipariş adediyle doğrudan değişmez.',
    },
    relatedGuide: { label: 'Katkı payı nedir?', href: '/rehberler/katki-payi-nedir' },
    relatedTool: { label: 'Kâr Marjı Hesaplayıcı', href: '/araclar/kar-marji-hesaplayici' },
    source: shopifyContribution,
  ...
  },
  {
    ...
    category: 'Kârlılık',
    shortDefinition:
      'Belirli kapasite ve zaman aralığında satış adediyle doğrudan değişmeyen giderdir.',
    explanation: [
    ...
    example:
      'Aylık sabit gider 200.000 TL ve ortalama sipariş katkısı 200 TL ise başabaş için yaklaşık 1.000 sipariş gerekir.',
    confusedWith: {
      term: 'Değişken gider',
      slug: 'degisken-gider',
      explanation: 'Değişken gider satış hacmiyle birlikte artar veya azalır.',
    },
    relatedGuide: { label: 'Katkı payı nedir?', href: '/rehberler/katki-payi-nedir' },
    source: shopifyContribution,
    reviewedAt: '2026-08-01',
  },
  {
    ...
    category: 'Dönüşüm',
    shortDefinition:
      'Belirli bir kohortta iade edilen sipariş veya ürünlerin toplam teslimata oranıdır.',
    explanation: [
    ...
    example:
      'Tamamlanmış 1.000 teslimat kohortunda 120 sipariş iade edildiyse sipariş iade oranı %12’dir.',
    confusedWith: {
      term: 'İptal oranı',
      explanation:
        'İptal çoğunlukla sevkiyat öncesi; iade teslimat sonrası oluşur ve ters lojistik yaratır.',
    },
    relatedGuide: {
      label: 'İade oranı kârlılığa nasıl eklenir?',
      href: '/rehberler/iade-orani-karliliga-nasil-eklenir',
    },
    relatedTool: { label: 'Başabaş ROAS Hesaplayıcı', href: '/araclar/basabas-roas-hesaplayici' },
    source: shopifyReturns,
    reviewedAt: '2026-08-01',
  },
  {
    slug: 'donusum-orani',
    term: 'Dönüşüm Oranı',
    english: 'Conversion Rate — CVR',
    category: 'Dönüşüm',
    shortDefinition:
      'Tanımlanan dönüşümü tamamlayan kullanıcı veya oturumların ilgili trafiğe oranıdır.',
    explanation: [
    ...
    example:
      '10.000 oturumda 250 satın alma gerçekleştiyse oturum bazlı satın alma dönüşüm oranı %2,5’tir.',
    confusedWith: {
      term: 'Tıklama oranı — CTR',
      explanation:
        'CTR reklamı tıklayanların gösterime oranıdır; CVR tıklama veya ziyaret sonrası dönüşümü ölçer.',
    },
    relatedGuide: {
      label: 'E-ticaret dashboardunda takip edilecek metrikler',
  ...
  {
    slug: 'ortalama-sepet-tutari',
    term: 'Ortalama Sepet Tutarı',
    ...
    confusedWith: {
      term: 'Müşteri başına gelir',
      explanation:
        'AOV sipariş sayısını; müşteri başına gelir benzersiz müşteri sayısını payda olarak kullanır.',
    },
    relatedGuide: {
      label: 'E-ticaret dashboardunda takip edilecek metrikler',
      href: '/rehberler/e-ticaret-dashboard-metrikleri',
...
export function getRelatedTerms(item: GlossaryTerm) {
  const sameCategory = glossaryTerms.filter(
    (term) => term.category === item.category && term.slug !== item.slug,
  )
  const confused = item.confusedWith.slug ? getGlossaryTerm(item.confusedWith.slug) : undefined
  return [confused, ...sameCategory]
    .filter(
      (term, index, all): term is GlossaryTerm =>
