...
export function renderAnnouncementSocialSvg(announcement: Announcement) {
  ...
  return Buffer.from(`
    <svg xmlns="http://www.w3.org/2000/svg" width="${SOCIAL_ANNOUNCEMENT_IMAGE_WIDTH}" height="${SOCIAL_ANNOUNCEMENT_IMAGE_HEIGHT}" viewBox="0 0 1080 1350">
      <style>
        .sans { font-family: Inter, Arial, sans-serif; fill: #101411; }
        .mono { font-family: Inter, Arial, sans-serif; fill: #101411; font-size: 22px; font-weight: 750; letter-spacing: 1.8px; }
        .title { font-family: Inter, Arial, sans-serif; fill: #101411; font-weight: 900; letter-spacing: -5.6px; stroke: #101411; stroke-width: 1.5px; paint-order: stroke fill; }
        .body { font-family: Inter, Arial, sans-serif; fill: #3F453F; font-size: 28px; font-weight: 600; }
        .stat-label { font-family: Inter, Arial, sans-serif; fill: #5F655F; font-size: 18px; font-weight: 750; letter-spacing: 1.2px; }
        .stat-value { font-family: Inter, Arial, sans-serif; fill: #101411; font-size: 58px; font-weight: 900; letter-spacing: -3px; stroke: #101411; stroke-width: .7px; paint-order: stroke fill; }
      </style>
      ...
      <g transform="translate(84 ${insightY})">
        ...
        <text x="58" y="51" fill="#FFFEF9" font-family="Inter, Arial, sans-serif" font-size="22" font-weight="750" letter-spacing="1.8">${escapeXml(upperTr(insight))}</text>
        <text x="862" y="51" fill="#D6FF63" font-family="Inter, Arial, sans-serif" font-size="22" font-weight="750" text-anchor="end">↗</text>
      </g>
