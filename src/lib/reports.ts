...
export const benchmarkReports: BenchmarkReport[] = [
  {
    ...
    rows: [
      { segment: 'Yüksek marj / düşük iade', margin: '%45', returnRate: '%4', breakEvenRoas: '2,2x', mer: '5,0x', signal: 'Ölçekleme alanı geniş' },
      { segment: 'Orta marj / düşük iade', margin: '%32', returnRate: '%6', breakEvenRoas: '3,1x', mer: '4,2x', signal: 'Kontrollü büyüme' },
      { segment: 'Orta marj / yüksek iade', margin: '%25', returnRate: '%14', breakEvenRoas: '4,0x', mer: '3,4x', signal: 'İade ve ürün deneyimini çöz' },
      { segment: 'Düşük marj / düşük iade', margin: '%18', returnRate: '%4', breakEvenRoas: '5,6x', mer: '2,6x', signal: 'İndirim ve CPA baskısı' },
      { segment: 'Düşük marj / yüksek iade', margin: '%10', returnRate: '%18', breakEvenRoas: '10,0x', mer: '1,8x', signal: 'Kampanya öncesi yeniden fiyatla' },
    ],
    decisions: [
      { signal: 'ROAS hedefi başabaş eşiğin altında', meaning: 'Atfedilen gelir iyi görünse de reklam sonrası katkı negatif olabilir.', action: 'Bütçeyi artırmadan ürün marjı, teklif ve iade etkisini yeniden hesapla.' },
      { signal: 'ROAS sabit, MER düşüyor', meaning: 'Platform atfı korunurken şirket düzeyi toplam verimlilik bozuluyor olabilir.', action: 'Organik gelir, diğer kanallar ve tam pazarlama gideriyle uzlaştır.' },
      { signal: 'İade oranı yükseliyor', meaning: 'Gelecekte gerçekleşecek maliyet bugünkü kampanya kararını olduğundan iyi gösterir.', action: 'Beklenen iade etkisini sipariş ekonomisine ekle ve ürün deneyimini incele.' },
    ],
    limitations: [
    ...
    sources: [
      { name: 'T.C. Ticaret Bakanlığı — Türkiye’de E-Ticaretin Görünümü', url: 'https://ticaret.gov.tr/duyurular/turkiyede-e-ticaretin-gorunumu-raporu-yayinlandi-12-05-2026', note: 'Pazar bağlamı için başvurulabilecek resmî kaynak; bu simülasyonun veri seti değildir.' },
      { name: 'Veri Mimarı — Başabaş ROAS yöntemi', url: '/rehberler/basabas-roas-nasil-hesaplanir', note: 'Hesaplama tanımı ve ekonomik eşik açıklaması.' },
    ],
    relatedGuides: [
      ...
      { title: 'İade oranı kârlılık hesabına nasıl eklenir?', href: '/rehberler/iade-orani-karlilik-hesabina-nasil-eklenir' },
    ],
    relatedTools: [
      ...
      { title: 'Kampanya Öncesi Marj Kontrol Listesi', href: '/sablonlar/kampanya-oncesi-marj-kontrol-listesi' },
    ],
  },
]
