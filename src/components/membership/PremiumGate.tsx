...
export default async function PremiumGate({
  ...
  return (
    <section className="tool-sm" style={{ maxWidth: 500, margin: '40px auto' }} aria-label="Kilitli içerik">
      <span className="tag yellow" style={{ marginBottom: 16 }}>PREMIUM İÇERİK</span>
