...
export const metadata: Metadata = {
  ...
  description:
    'ROAS, MER, CPA, atıf ve katkı metriklerini kampanya teşhisinden şirket bütçesine uzanan tek bir reklam ölçüm sisteminde birleştirin.',
...
const toolCards = [
  {
    ...
    description:
      'Çoklu ürün reklam sınırlarını, fiyatı ve sabit giderleri aynı portföy görünümünde analiz edin.',
    ...
    <main className="page">
      ...
      <section className="hero-shell advertising-pillar-hero">
        <div className="wrap hero">
          <div className="hero-copy">
            <div className="crumb">
              <i aria-hidden="true" />
              REKLAM ANALİTİĞİ / ANA ÖĞRENME YOLU
            </div>
            <h1>
              Paneli değil, <span className="accent">kararı</span> ölçün.
            </h1>
            <p className="intro">
              Kreatif tıklamasından şirket gelirine, ROAS’tan reklam sonrası katkıya kadar her
              metriği doğru karar seviyesine yerleştirin.
            </p>
            <div className="actions-row">
              <a className="btn hero-primary" href="#olcum-yolu">
                Ölçüm yoluna başla ↘
              </a>
              <a className="hero-link" href="/karsilastirmalar/roas-vs-mer">
                ROAS ve MER’i karşılaştır
              </a>
            </div>
            <div className="signals">
              <span className="tag">
                <i />6 uygulama rehberi
              </span>
              <span className="tag">
                <i />2 çalışan analiz aracı
              </span>
              <span className="tag">
                <i />1 karar karşılaştırması
              </span>
            </div>
          </div>

          <div className="advertising-console" aria-label="Reklam ölçüm katmanları">
            <div className="advertising-console-head">
              <span className="eyebrow">ÖLÇÜM KONSOLU</span>
              <i>CANLI ÇERÇEVE</i>
            </div>
            <div className="advertising-console-flow">
              <div>
                <small>01 / SİNYAL</small>
                <strong>CPM · CTR · CPC</strong>
                <p>Reklamın erişim ve tıklama kalitesi.</p>
              </div>
              <div>
                <small>02 / DÖNÜŞÜM</small>
                <strong>CVR · CPA · CAC</strong>
                <p>Trafiğin sipariş veya müşteriye dönüşümü.</p>
              </div>
              <div>
                <small>03 / ATIF</small>
                <strong>ROAS</strong>
                <p>Platformun reklama yazdığı gelir verimliliği.</p>
              </div>
              <div>
                <small>04 / ŞİRKET</small>
                <strong>MER</strong>
                <p>Toplam gelirin toplam pazarlama harcamasına oranı.</p>
              </div>
              <div>
                <small>05 / EKONOMİ</small>
                <strong>Katkı · POAS</strong>
                <p>Reklamdan sonra gerçekten kalan ekonomik sonuç.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="section-band band-dark advertising-principle">
        <div className="wrap section">
          ...
          <p>
            Kreatif için CTR ve CVR, kampanya için ROAS ve CPA, şirket bütçesi için MER, kârlı
            büyüme için reklam sonrası katkı gerekir. Bu katmanları aynı tanım, dönem ve veri
            kaynağıyla uzlaştırmadan bütçe kararına geçmeyin.
          </p>
        </div>
      </section>
        ...
        <div className="wrap section">
          <div className="head">
            <div>
              ...
              <h2>Reklam ölçüm yolu.</h2>
            </div>
            <p>Önce raporu kurun; sonra metriği, ekonomik eşiği ve bütçe kararını bağlayın.</p>
          </div>
      ...
      <section className="section-band band-cyan">
        <div className="wrap section">
          <div className="head">
            <div>
              <span className="eyebrow">KARAR KATMANI</span>
              <h2>Aynı veriyi üç farklı açıdan okuyun.</h2>
            </div>
            <p>
              Karşılaştırma, demo vaka ve araç aynı ölçüm çerçevesini farklı görevlerde çalıştırır.
            </p>
          </div>
          <div className="advertising-decision-grid">
            <a href="/karsilastirmalar/roas-vs-mer">
              <span>01 / KARŞILAŞTIRMA</span>
              <h3>ROAS vs MER</h3>
        ...
        <div className="wrap section">
          <div className="head">
            <div>
              ...
              <h2>Eşiği kendi verinizle hesaplayın.</h2>
            </div>
            <p>Reklam hedefini sektör ortalamasından değil ürün ekonominizden türetin.</p>
          </div>
          <div className="grid profitability-tools">
            {toolCards.map((tool, index) => (
              <a className="card" key={tool.href} href={tool.href}>
      ...
      <section className="section-band band-paper">
        <div className="wrap section">
          <div className="head">
            <div>
              <span className="eyebrow">METRİK SÖZLÜĞÜ</span>
              <h2>Raporun dilini sabitleyin.</h2>
            </div>
            <p>Her metriğin formülünü, kapsamını ve karıştırıldığı kavramı görün.</p>
          </div>
